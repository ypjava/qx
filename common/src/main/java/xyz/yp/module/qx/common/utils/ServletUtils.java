package xyz.yp.module.qx.common.utils;
...
public class ServletUtils {
	 ...
	 * @throws IOException
	 */
	public static void outputFile(HttpServletResponse response, Resource[] resources, boolean gzip) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void outputFile(HttpServletResponse response, Resource resource, boolean gzip) throws IOException {
		OutputStream output = null;
	...
	public static void writeToResponseWithOnlyYMDDate(HttpServletResponse response, Map<? extends Object, Object> res) {
		...
		JsonUtils.writeWithOnlyYMDDate(out, res);
	}
	 ...
	 * @param jsonStr
	 */
	public static void outResult(HttpServletResponse response, String jsonStr) {
		try {
			response.setContentType("text/plain;charset=" + CODE_UTF8);
	 ...
	 * @param jsonObj
	 */
	public static void outResult(HttpServletResponse response, JSONObject jsonObj) {
		response.setContentType("text/plain;charset=" + CODE_UTF8);
	 ...
	 * @param jsonObj
	 */
	public static void outResult(HttpServletResponse response, JSONArray jsonObj) {
		response.setContentType("text/plain;charset=" + CODE_UTF8);
		PrintWriter out = null;
		try {
			out = response.getWriter();
	 ...
	 * @param result
	 */
	public static void outResult(HttpServletResponse response, Object result) {
		response.setContentType("text/plain;charset=" + CODE_UTF8);
		PrintWriter out = null;
		try {
			out = response.getWriter();
